...
public class Game {
  ...
  /*  public static void gameWithComputer(Player p1, ComputerPlayer p2, Scanner sc, TicTacToeSquare a1, TicTacToeSquare a2, TicTacToeSquare a3, TicTacToeSquare b1, TicTacToeSquare b2, TicTacToeSquare b3, TicTacToeSquare c1, TicTacToeSquare c2, TicTacToeSquare c3, ArrayList<TicTacToeSquare> allSquares, boolean isFirstPlayer, int firstPlayerScore, int secondPlayerScore) {
        if ((a1.getValue().equals(a2.getValue()) && a2.getValue().equals(a3.getValue()) && !a1.getValue().equals(" ")) //each stands for any kind of winning (in a row och in a column)
                || (b1.getValue().equals(b2.getValue()) && b2.getValue().equals(b3.getValue()) && !b1.getValue().equals(" "))
                || (c1.getValue().equals(c2.getValue()) && c2.getValue().equals(c3.getValue()) && !c1.getValue().equals(" "))
                || (a1.getValue().equals(b1.getValue()) && b1.getValue().equals(c1.getValue()) && !c1.getValue().equals(" "))
            ...
            gameWithComputer(p1, p2, sc, a1, a2, a3, b1, b2, b3, c1, c2, c3, allSquares, isFirstPlayer, firstPlayerScore, secondPlayerScore);
        }

    }

    static void playAgainQuestion(Player p1, ComputerPlayer p2, Scanner sc, int firstPlayerScore, int secondPlayerScore) {
        System.out.println("Would you like to play one more time? yes/no");
        while (true) {
            String playAgainAnswer = sc.nextLine();
            String playAgainAnswerLowerCase = playAgainAnswer.toLowerCase();// doesn't work
